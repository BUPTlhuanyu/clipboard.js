...
class ClipboardActionDefault {
  ...
  initSelection() {
    ...
    if (this.text) {
      const fakeElement = createFakeElement(this.text);
      this.selectFakeTarget(fakeElement);
      succeeded = command('copy');
      this.removeFake();
    } else if (this.target) {
      this.selectedText = select(this.target);
      succeeded = command(this.action);
    }
  ...
  selectFakeTarget(fakeElement) {
    ...
    this.selectedText = select(fakeElement);
  }
